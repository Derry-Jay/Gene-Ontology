...
<template>
  <div class="animsition-overlay">
    ...
    <div class="grid flex16">
      <div class="row">
        <div class="colw_6">
          <h2 id="title-sub2"> clustering</h2>
        </div>
        <div class="col_6">
          <div class="bannerbox">
            <div class="banner">
    ...
    <div>
      <h1 style="margin-left: 600px">GENE DISEASE LIST</h1>
          <table style="margin-left: 400px;width: 600px;background-color: darkgray;padding: 20px">
              <tr><td><strong>Serial No</strong></td><td><strong>Disease Name ID</strong></td><td><strong>Disease Name List</strong></td><td><strong>Image</strong></td><td><strong>Category</strong></td></tr>
              <form method="post" action="mfbpcc.jsp">
                 <tr><td><center><%=kkk%></center></td><td><%=did%></td><td><center><%=dis%></center></td><td ><%=lst%><img  src="<%=img%>" style="width:300px;height:200px;"></td><td> <input type="text" value="<%=id%>" name="id" hidden=""><input type="submit"  value="Find Disease Category"></td></tr>
              </form>
            </table>
        </div>
   </div>
